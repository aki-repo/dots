...
local function set_wallpaper(s)
    ...
    if beautiful.wallpaper then
        local wallpaper = ("/home/aki/Pictures/grey_mtn.jpg")
...
awful.screen.connect_for_each_screen(function(s)
    ...
    s.mybrightness:connect_signal('mouse::enter', function(self)
        ...
        -- Reveal slider
        s.mybrightness:get_children_by_id("slider_box")[1].forced_height = 200
    ...
    s.myvolume:connect_signal('mouse::enter', function(self)
        ...
        -- Reveal slider
        s.myvolume:get_children_by_id("slider_box")[1].forced_height = 200 
    ...
    s.mypower:connect_signal('mouse::enter', function(self)
        s.mypower:get_children_by_id("slider_box")[1].forced_height = 200
    end)
